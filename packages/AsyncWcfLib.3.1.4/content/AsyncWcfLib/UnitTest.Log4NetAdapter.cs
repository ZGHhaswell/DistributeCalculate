...
{
    /// <summary>
    /// This class is used to adapt the WcfTrc output to the Log4Net package.
    ...
    /// </summary>
    public class Log4NetAdapter : WcfTrc.ITracePlugin
    {
    ...
    public class Log4NetTest
    {
        ...
        public static void ClassInitialize(TestContext testContext)
        {
            ...
            // redirect all trace output of AsyncWcfLib to the Log4NetAdapter:
            WcfTrc.UsePlugin(new Log4NetAdapter(defaultLogger));
        ...
        public void When10ClientsSendTo1AsyncService_ThenUseLog4Net()
        {
            ...
            Helper.RunTestInWpfSyncContext(async () =>
            {
                ...
                // we also can write through the AsyncWcfLib tracing system (as the library does)
                WcfTrc.Info("AsyncWcfLib Trace", "redirected trace line to log4netLogger ...", log4netLogger);

...
namespace UnitTest
{
    ...
    /// see the wiki [http://sourceforge.net/p/asyncwcflib/wiki/Home].
    /// 
    ...
    public class ActorDemo
    {
        ...
        public void ActorDemo_PingPong()
        {
            ...
            Helper.RunTestInWpfSyncContext( async () =>
            {
                ...
                m_foreignActor.PongOutput.LinkOutputToRemoteService( new Uri( "net.tcp://localhost:40001/AsyncWcfLib/PingPongInput" ) );
                m_foreignActor.Open();
        ...
        {
            WcfTrc.Error("PingPongTest received ErrorMessage", rsp.ToString());
        }
